...
const requirements = [
  ...
  [files.main, "YOUR RECOVERY ROADMAP", "touchable session-based patient roadmap"],
  [files.main, "data-roadmap-node", "touchable roadmap session nodes"],
  [files.main, "path-biome-motion", "phase-specific roadmap motion layers"],
  ...
  [files.main, "YOUR RECOVERY ROADMAP", "three-phase treatment roadmap"],
