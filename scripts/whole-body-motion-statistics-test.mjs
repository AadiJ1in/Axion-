...
assert.equal(rep1.motionStatisticsSchemaVersion, 1);
...
assert.match(session.interpretation, /tracking noise|strategy/i);

console.log("Whole-body path-based motion statistics passed.");
