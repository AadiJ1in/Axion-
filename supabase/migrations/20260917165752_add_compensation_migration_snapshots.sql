...
comment on table public.movement_biomechanics_sessions is 'Privacy-minimized, pose-derived session summaries for longitudinal movement redistribution review. Stores numeric summaries only; no raw video or images.';
comment on column public.movement_biomechanics_sessions.compensation_analysis is 'Descriptive rules-based movement redistribution analysis for clinician review; not a diagnosis or injury prediction.';
